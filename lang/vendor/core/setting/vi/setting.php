...
return [
    ...
    'general' => [
        ...
        'no' => 'Tắt',
        'locale' => 'Ngôn ngữ',
        'admin_appearance_description' => 'Cài đặt một số giao diện như logo, ảnh nền đăng nhập, bộ soạn thảo,...',
        'admin_appearance_title' => 'Cài đặt giao diện',
        'admin_login_screen_backgrounds' => 'Ảnh nền màn hình đăng nhập (~1366x768)',
    ...
    'email' => [
        ...
        'description' => 'Cấu hình cài đặt gửi email.',
    ...
    'description' => 'Mô tả',
    'enable' => 'Bật',
    'test_send_mail' => 'Gửi email test',
    'email_setting_title' => 'Cấu hình email',
    'field_type_not_exists' => 'Loại field này không được hỗ trợ',
    'test_email_description' => 'Để gửi email test, hãy đảm bảo rằng bạn đã cập nhật cấu hình SMTP để gửi thư!',
    'test_email_input_placeholder' => 'Nhập email mà bạn muốn gửi email test.',
    'test_email_modal_title' => 'Gửi một email test',
