        ...
        <div class="container-fluid w90 padtop30" style="padding: 15px 0;">
            <div class="col-12">
                ...
                <p class="addresshouse">
                    ...
                    @endif
                    <span class="d-inline-block" style="margin-left: 10px"><i class="fa fa-calendar-alt"></i> {{ $project->created_at->translatedFormat('d-m-Y') }}</span>
                </p>
                <div class="d-none">
            ...
            <div class="row">
                <div class="col-md-8">
                        ...
                        <div class="col-sm-6 lineheight220">
                            ...
                            <div>
                                ...
                                <b>@if ($project->price_from)
                                    ...
                                    @if ($project->price_to) - {{ format_price($project->price_to, $project->currency) }} /m² @endif
                                </b>
                            </div>
                            @endif
                        </div>
                    ...
                    @if ($project->latitude && $project->longitude)
                        {!! Theme::partial('real-estate.elements.traffic-map-modal', ['location' => $project->city->name ? $project->city->name . ', ' . $project->state->name : $project->state->name]) !!}
                    @else
