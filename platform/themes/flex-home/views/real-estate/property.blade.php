...
<main class="detailproject bg-white">
    ...
    <div class="container-fluid w90 padtop20">
        <h1 class="titlehouse">{!! BaseHelper::clean($property->name) !!}</h1>
        ...
        <p class="addresshouse">
            ...
            @endif
            <span class="d-inline-block" style="margin-left: 10px"><i class="fa fa-calendar-alt"></i> {{ $property->created_at->translatedFormat('d/m/Y') }}</span>
        </p>
        <div class="d-none">
            {!! Theme::partial('breadcrumb') !!}
        </div>
        <p class="pricehouse"> <?php echo str_replace("t", " t",str_replace("₫", "", $property->price_html));?> ~ {{ format_price($property->price/$property->square)}}/m² {!! $property->status_html !!}</p>
        <div class="row">
            <div class="col-md-8">
                <div class="row pt-3">
                    <div class="col-sm-12">
                        ...
                        <div class="row py-2">
                            <div class="col-sm-12">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        <td>{{ __('Price') }}</td>
                                        <td><strong><?php echo str_replace("t", " t",str_replace("₫", "đồng", $property->price_html)); ?></strong></td>
                                    </tr>
                ...
                @if ($property->latitude && $property->longitude)
                    {!! Theme::partial('real-estate.elements.traffic-map-modal', ['location' => $property->city->name ? $property->city->name . ', ' . $property->state->name : $property->state->name]) !!}
                @else
