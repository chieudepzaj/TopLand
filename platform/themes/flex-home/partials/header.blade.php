...
<head>
    ...
    @if(request()->is('/'))
    <title>Website số 1 về bất động sản - Mua bán, cho thuê nhà đất toàn quốc | Topland.vn</title>
    @endif
    <meta name="keywords" content="bất động sản, mua bán bất động sản, cho thuê bất động sản, mua bán nhà đất">
    <meta name="description" content="Chuyên trang mua bán nhà đất, cung cấp nền tảng đăng tin bất động sản mua bán/cho thuê nhà đất, đất nền, dự án, căn hộ chung cư, văn phòng,... Cập nhật tin tức thị trường bất động sản uy tín, nhanh chóng, chính xác hàng đầu Việt Nam">
