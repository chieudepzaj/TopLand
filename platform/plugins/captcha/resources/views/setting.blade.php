            ...
            <div class="form-group mb-3">
                ...
                <label class="me-2">
                    <input type="radio" name="enable_captcha"
                                                value="1"
                                                @if (setting('enable_captcha')) checked @endif class="setting-selection-option" data-target="#captcha-settings">{{ trans('core/setting::setting.general.yes') }}
                </label>
                <label>
                    <input type="radio" name="enable_captcha"
                                                value="0"
                                                @if (!setting('enable_captcha')) checked @endif class="setting-selection-option" data-target="#captcha-settings">{{ trans('core/setting::setting.general.no') }}
                </label>
            </div>
