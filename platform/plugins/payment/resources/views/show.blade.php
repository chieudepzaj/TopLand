            ...
            <div class="col-md-9">
                <div class="widget meta-boxes">
                    ...
                    <div class="widget-body">
                        <p>{{ trans('plugins/payment::payment.created_at') }}: <strong>{{  BaseHelper::formatDate($payment->created_at, 'd-m-Y H:i:s')  }}</strong></p>
                        <p>{{ trans('plugins/payment::payment.payment_channel') }}: <strong>{{ $payment->payment_channel->label() }}</strong></p>
                        <p>{{ trans('plugins/payment::payment.total') }}: <strong>{{ intval($payment->amount) }} {{ $payment->currency }}</strong></p>
